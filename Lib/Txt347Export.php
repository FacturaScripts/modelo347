...
class Txt347Export
{
    ...
    protected static function getCompanyData(): string
    {
        return '1' // TIPO DE REGISTRO
            ...
            . (self::$total < 0 ? 'N' : ' ') . self::formatString((int)self::$total, 13, '0', STR_PAD_LEFT) . self::formatString(self::$total - (int)self::$total, 2, '0', STR_PAD_LEFT) // IMPORTE TOTAL ANUAL DE LAS OPERACIONES
    ...
    protected static function getCustomerData(): string
    {
        ...
        foreach (self::$customersData as $item) {
            ...
            $txt .= "\n"
                ...
                . (self::$total < 0 ? 'N' : ' ') . self::formatString((int)self::$total, 13, '0', STR_PAD_LEFT) . self::formatString(self::$total - (int)self::$total, 2, '0', STR_PAD_LEFT) // IMPORTE ANUAL DE LAS OPERACIONES
                . '-' // OPERACIÓN SEGURO
                ...
                . ($item['t1'] < 0 ? 'N' : ' ') . self::formatString((int)$item['t1'], 13, '0', STR_PAD_LEFT) . self::formatString($item['t1'] - (int)$item['t1'], 2, '0', STR_PAD_LEFT) // IMPORTE DE LAS OPERACIONES PRIMER TRIMESTRE
                . self::formatString('', 16, '-', STR_PAD_LEFT) // IMPORTE PERCIBIDO POR TRANSMISIONES DE INMUEBLES SUJETAS A IVA PRIMER TRIMESTRE
                . ($item['t2'] < 0 ? 'N' : ' ') . self::formatString((int)$item['t2'], 13, '0', STR_PAD_LEFT) . self::formatString($item['t2'] - (int)$item['t2'], 2, '0', STR_PAD_LEFT) // IMPORTE DE LAS OPERACIONES SEGUNDO TRIMESTRE
                . self::formatString('', 16, '-', STR_PAD_LEFT) // IMPORTE PERCIBIDO POR TRANSMISIONES DE INMUEBLES SUJETAS A IVA SEGUNDO TRIMESTRE
                . ($item['t3'] < 0 ? 'N' : ' ') . self::formatString((int)$item['t3'], 13, '0', STR_PAD_LEFT) . self::formatString($item['t3'] - (int)$item['t3'], 2, '0', STR_PAD_LEFT) // IMPORTE DE LAS OPERACIONES TERCER TRIMESTRE
                . self::formatString('', 16, '-', STR_PAD_LEFT) // IMPORTE PERCIBIDO POR TRANSMISIONES DE INMUEBLES SUJETAS A IVA TERCER TRIMESTRE
                . ($item['t4'] < 0 ? 'N' : ' ') . self::formatString((int)$item['t4'], 13, '0', STR_PAD_LEFT) . self::formatString($item['t4'] - (int)$item['t4'], 2, '0', STR_PAD_LEFT) // IMPORTE DE LAS OPERACIONES CUARTO TRIMESTRE
